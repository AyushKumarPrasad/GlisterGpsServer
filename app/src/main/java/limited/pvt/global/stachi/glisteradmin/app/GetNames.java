            ...
            protected void populateViewHolder( NameViewHolder viewHolder, final User model, int position)
            {
                ...
                viewHolder.itemClickListener = new ItemClickListener()
                {
                    ...
                    public void onClick(View view, int position)
                    {
                        ...
                        {
                            Intent map = new Intent(GetNames.this, GetAttendance.class);
                            map.putExtra("name", model.getName());
                            startActivity(map);
                        }
                        else
                        {
                            Toast.makeText(GetNames.this,"You are admin my friend " , Toast.LENGTH_SHORT).show();
                        }
                    }
                };

                viewHolder.txtChating.setOnClickListener(new View.OnClickListener()
                {
                    @Override
                ...
                viewHolder.txtImage.setOnClickListener(new View.OnClickListener()
                {
                    @Override
                    public void onClick(View v)
                    {
                        ...
                        if (! model.getName().equals(Common.currentUser.getName()))
                        {
                            Intent map = new Intent(GetNames.this, ImagesActivity.class);
                            map.putExtra("name", model.getName());
                            startActivity(map);
                        }
                        else
